...
//  }
    ...
    public static void askForSpecialPermission(final AppCompatActivity activity, String permission,
    ...
    public static void askForPermissionSingle(Fragment fragment, String permission,
                                              PermissionCallback permissionCallback) {
...
//    }
    ...
    private static void askForPermissionList(Fragment fragment, String[] permissions,
                                             PermissionCallback permissionCallback) {
        if (permissionCallback == null) {
            return;
        }
